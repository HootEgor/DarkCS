...
type OrderManagerResponse struct {
	Response  string   `json:"response"`
	Codes     []string `json:"codes"`
	ShowCodes bool     `json:"show_codes"`
}

func (o *Overseer) askOrderManager(user *entity.User, userMsg string) (string, []entity.ProductInfo, error) {
	...
	completed := o.handleRun(user, thread.ID, o.assistants[entity.OrderManagerAss])
	if !completed {
	...
	var response OrderManagerResponse
